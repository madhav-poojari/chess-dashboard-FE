...
interface GalleryGridProps {
    ...
    isAdmin?: boolean;
    /** Optional callback to render author info below tags in the overlay */
    authorInfo?: (img: GalleryImage) => string | undefined;
}
            ...
            {images.map((img) => {
                ...
                return (
                    ...
                    >
                        ...
                        {/* Title, tags & author overlay */}
                        {(img.title || (img.tags && img.tags.length > 0) || author) && (
